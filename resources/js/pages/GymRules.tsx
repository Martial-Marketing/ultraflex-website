            ...
            <div className="min-h-screen relative flex items-center justify-center py-8 px-2 sm:px-6">
                ...
                <div className="relative z-10 w-full max-w-4xl bg-black/70 rounded-2xl shadow-2xl border border-gray-800 backdrop-blur-md p-6 sm:p-10">
                    ...
                    <div className="text-center">
                        <p className="text-base sm:text-lg text-gray-300 mb-3 font-normal leading-relaxed max-w-xl mx-auto">Thank you for your cooperation. By following these rules, we can all contribute to making <span className="ultraflex-ultra text-white">ULTRA</span><span className="ultraflex-flex text-red-600">FLEX</span> the ultimate training environment.</p>
