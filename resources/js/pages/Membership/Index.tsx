        ...
        <div className="relative z-10 container mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm shadow-lg">
              ...
              <p className="mt-4 text-gray-300">
                Dual site access memberships for existing members: email your request to{' '}
                <a href="mailto:info@ufg" className="text-red-600 underline underline-offset-2">info@ufg</a>.
              </p>
            </div>
          </div>
          ...
          <div className="mt-10">
            <a href={ashbourneUrl} target="_blank" rel="noopener noreferrer">
              <Button size="lg" className="bg-gradient-to-r from-red-700 to-red-800 hover:from-red-600 hover:to-red-700 px-6">
